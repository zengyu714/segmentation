...
def train():
    ...
    mini_2 = conv3d_as_pool(mini_1, 16, 16, 'scaled_x4')
    mini_3 = conv3d_as_pool(mini_2, 16, 64, 'scaled_x8')
    mini_4 = conv3d_as_pool(mini_3, 64, 256, 'scaled_x16')
    ...
    with tf.name_scope('refineNet_3'):
        with tf.name_scope('rcu'):
            ...
            with tf.name_scope('from_3'):
                rcu_3 = _rcu(mini_3, 3, 64, 64, 'rcu3_1')
                rcu_3 = _rcu(rcu_3, 3, 64, 64, 'rcu3_2')
        ...
        with tf.name_scope('fusion'):
            ...
            fusion_4 = deconv_as_up(rcu_4, 3, 256, 64, 'fusion4')
    ...
    with tf.name_scope('refineNet_2'):
        with tf.name_scope('rcu'):
            with tf.name_scope('from_2'):
                rcu_2 = _rcu(mini_2, 3, 16, 16, 'rcu2_1')
                rcu_2 = _rcu(rcu_2, 3, 16, 16, 'rcu2_2')
            with tf.name_scope('from_3'):
                rcu_3 = _rcu(out, 3, 64, 64, 'rcu3_1')
                rcu_3 = _rcu(rcu_3, 3, 64, 64, 'rcu3_2')
        with tf.name_scope('fusion'):
            fusion_2 = tf.identity(rcu_2, name='fusion2')
            fusion_3 = deconv_as_up(rcu_3, 3, 64, 16, 'fusion3')
    ...
    with tf.name_scope('refineNet_1'):
        with tf.name_scope('rcu'):
            ...
            with tf.name_scope('from_2'):
                rcu_2 = _rcu(out, 3, 16, 16, 'rcu2_1')
                rcu_2 = _rcu(rcu_2, 3, 16, 16, 'rcu2_2')
        with tf.name_scope('fusion'):
            fusion_1 = tf.identity(rcu_1, name='fusion1')
            fusion_2 = deconv_as_up(rcu_2, 2, 16, 16, 'fusion2')
